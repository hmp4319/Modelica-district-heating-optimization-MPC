...
init_fmu = compile_fmu("Package.Simu",["OpFile.mop", "Plants.mo"] , compiler_options={'generate_html_diagnostics': True})
...
# 2.3.6 Get inputs
csv_data = pd.read_csv('Inputs.csv')
...
op = transfer_optimization_problem("Package.Opt", ["OpFile.mop", "Plants.mo"], compiler_options={'generate_html_diagnostics': True, 'equation_sorting': True})
op.set('Vwt', Vwt)
